...
class CICDRunner:
    ...
    def run_command(
        ...
        try:
            ...
            return {"success": False, "exit_code": -1, "error": "Command timed out after 1 hour"}
        except Exception as e:
            return {"success": False, "exit_code": -1, "error": f"Failed to execute: {str(e)}"}
    ...
    def validate_pipeline(self) -> Dict[str, Any]:
        ...
        if validate_result["success"]:
            results["checks"].append(
                {"name": "Syntax Validation", "passed": True, "message": "Configuration is valid"}
            )
        else:
            results["checks"].append(
                {
    ...
    def plan_with_output(self, output_file: str = "tfplan") -> Dict[str, Any]:
        ...
        result = self.run_command(
            "plan", detailed_exitcode=True, extra_args=[f"-out={output_file}"]
        )
    ...
    def apply_from_plan(self, plan_file: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "exit_code": -1, "error": f"Failed to apply plan: {str(e)}"}
    ...
    def run_full_pipeline(self, skip_init: bool = False, skip_validation: bool = False) -> bool:
        """
